...
public enum ErrorStatus implements ResponseCode {
    ...
    ACCOUNT_DORMANT(HttpStatus.FORBIDDEN, "ACCOUNT002", "휴면 계좌입니다."),
    ...
    TRANSFER_LIMIT_EXCEEDED(HttpStatus.BAD_REQUEST, "TRANSFER005", "잔액 또는 출금 한도로 인해 송금이 불가능합니다."),
    UNKNOWN_TRANSFER_DENIED_REASON(HttpStatus.BAD_REQUEST, "TRANSFER006", "송금이 허용되지 않는 사유입니다."),
